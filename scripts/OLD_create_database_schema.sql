...
GRANT ALL ON TABLE public.identity_role_claims TO postgres;

GRANT ALL ON TABLE public.identity_roles TO postgres;

GRANT ALL ON TABLE public.identity_user_claims TO postgres;

GRANT ALL ON TABLE public.identity_user_logins TO postgres;

GRANT ALL ON TABLE public.identity_user_roles TO postgres;

GRANT ALL ON TABLE public.identity_user_tokens TO postgres;

GRANT ALL ON TABLE public.identity_users TO postgres;
