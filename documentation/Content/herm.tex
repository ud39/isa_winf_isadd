...
Higher-Order\\
The Higher Order located was translate by taken the LOCATION primary key aswell as the primary keys from the relationship of organised\_by.\\\\
Cluster\\ 
The ARTICLE cluster with the connection to the following entites: EQUIPMENT, COFFEE\_DRINK, BEAN and BLEND was transform with the seperation   approach.\\
...
Time is a combination of the following attributes:
