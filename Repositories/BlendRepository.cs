...
namespace WinfADD.Repositories
{
    public class BlendRepository : GenericBaseRepository<Blend, BlendPreview>
    {
        ...
        public async Task<bool> InsertTable(BlendInsertModel blendObj, IDictionary<string, dynamic> propertyValues)
        {

            var sqlBlend = "INSERT INTO blend ";
            var sqlBeans = "INSERT INTO composed_essential (blend_name, bean_name, bean_provenance) " +
                                         "VALUES (@blend_name, @bean_name, @bean_provenance)";


            sqlBlend += " (name, provenance)" + " VALUES " + "(@name, @provenance);";
            Console.WriteLine("INSERT SHOP:: " + sqlBlend);
