...
CREATE TABLE consists_of(
                            ...
                            FOREIGN KEY (bean_manufacturer_name, bean_name, provenance) REFERENCES bean (manufacturer_name, name, provenance) ON DELETE CASCADE
);
...
CREATE TABLE reachable(
                          ...
                          FOREIGN KEY (coffee_shop_address, coffee_shop_name) REFERENCES coffee_shop (address, name) ON DELETE CASCADE,
                          FOREIGN KEY (bus_station_name, line) REFERENCES bus_station (name, line) ON DELETE CASCADE
...
CREATE TABLE provides (
                          ...
                          FOREIGN KEY (bean_name, bean_manufacturer_name, provenance) REFERENCES bean (name, manufacturer_name, provenance) ON DELETE CASCADE,
                          FOREIGN KEY (coffee_shop_name, coffee_shop_address) REFERENCES coffee_shop (name, address) ON DELETE CASCADE
);
...
insert into coffee_shop values ('Coffee_shop_Name3', ('Kieler Straße', 5, 24232, 'Kiel', 'Deutschland'), false, false, true, 'Textbeschreibung', false, true, 'www.nene.ne', 2019, true, false, 50, false, 'foood', 0);
insert into coffee_shop values ('Coffee_shop_Name2', ('Kieler Straße', 5, 24232, 'Kiel', 'Deutschland'), false, false, true, 'Textbeschreibung', false, true, 'www.nene.ne', 2019, true, false, 50, false, 'foood', 0);
...
-- example for delete with defined-type address --
insert into supplies values ('Kaffeemühle', 'Coffee_shop_Name2', ('Kieler Straße', 5, 24232, 'Kiel', 'Deutschland'));
delete from supplies where equipment_category_name ='Kaffeemühle' AND coffee_shop_name = 'Coffee_shop_Name2' AND (coffee_shop_address).street_name = 'Kieler Straße' AND (coffee_shop_address).street_number = 5 AND (coffee_shop_address).postal_code = 24232 AND (coffee_shop_address).town = 'Kiel' AND (coffee_shop_address).country = 'Deutschland'
